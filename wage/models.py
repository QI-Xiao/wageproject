...
class Employee(models.Model):
    ...
    which_shop = models.CharField(max_length=10, choices=SHOP, verbose_name='员工所属门店')
...
class Order(models.Model):
    ...
    commission_rate_new = models.FloatField(default=0, verbose_name='新订单提成')
    commission_rate_wed = models.FloatField(default=0, verbose_name='完成服务提成')
    ...
    whose_new = models.ForeignKey('Employee', on_delete=models.CASCADE, related_name='whose_order_new', verbose_name='新订单负责人')
    whose_wed = models.ForeignKey('Employee', on_delete=models.CASCADE, related_name='whose_order_wed', verbose_name='完成服务负责人')
    which_shop = models.CharField(max_length=10, choices=SHOP, verbose_name='订单所属门店')
    ...
    unusual_change = models.TextField(null=True, blank=False, verbose_name='异常状态')
    task_and_changepeople = models.BooleanField(default=False, verbose_name='更换人且为任务单')
    origin_status = models.IntegerField(default=0, choices=ORDER_STATUS, verbose_name='退单前订单状态')
